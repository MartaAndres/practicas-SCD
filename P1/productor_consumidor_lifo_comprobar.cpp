...
bool consumido[num_items]; // elementos consumidos (comprobacion)
...
int main() {
   ...
   // comprobacion de que se ha consumido todo
   bool ok = true;
   for (int i = 0; i < num_items; i++) {
      ok = ok && consumido[i];
   }
   if (ok)
      cout << "Se han consumido todos los elementos\n";
   else
      cout << "No se han consumido todos los elementos\n";
}
